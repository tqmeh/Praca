...
public class DodajZleceniodawce extends JFrame {
    ...
    private krajRepozytorium KrajRepozytorium;
    private uzytkownicyRepozytorium UzytkownicyRepozytorium;
    private zleceniodawcaRepozytorium ZleceniodawcaRepozytorium;
    double Regon1;
    ...
    public void StworzDodawanieZleceniodawcy()
    {
        JDialog jDialog=new JDialog();
        Metody metody=new Metody();
        jDialog.setTitle("Dodaj zleceniodawce");
...
public void SprawdzCzyDaneWypelnione(JDialog jDialog)
{
    ...
    else
    {
        if(!Regon.isEmpty())
        {
            ...
            JOptionPane.showMessageDialog(this, "Dodano nowego zleceniodawce o nazwie "+NazwaSkrocona);
            jDialog.dispose();
        }
        else
        {
...
public void DodajDaneKrajowdoJComboBoxa()
{
    ...
    List<Encje.kraj> krajList=KrajRepozytorium.findAll();
    ...
    {
        zleceniodawca Zleceniodawca=new zleceniodawca(nazwaSkrocona,nazwaPelna,kraj,ulica,numerDomu,numerMieszkania,kodPocztowy,miasto,nip,Regon,telefonStacjonarny,telefonKomorkowy,mail,
                skype,idFirmy,nazwaFirmy,userID,nazwauzytkownika);
        ZleceniodawcaRepozytorium.save(Zleceniodawca);
    }
public void WyswietlTabele()
{
    List<Encje.zleceniodawca> zleceniodawcaList=ZleceniodawcaRepozytorium.findCompanyByFirmaId(IdFirmy);
    Object[][] dane=new Object[zleceniodawcaList.size()][11];
    for(int i=0;i<zleceniodawcaList.size();i++)
    {
        zleceniodawca zleceniodawca1=zleceniodawcaList.get(i);
    ...
    public void UsunzBazyDanych()
    {
        ...
        if(WybranyWiersz!=-1)
        {
            ...
            ZleceniodawcaRepozytorium.deleteById(Id);
